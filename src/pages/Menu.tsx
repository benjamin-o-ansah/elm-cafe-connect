...
//           className="fixed bottom-20 right-5 z-50 h-16 w-16 rounded-full bg-background shadow-lg animate-scale-in"
//           size="icon"
//         >
...
import { Button } from "@/components/ui/button";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@/components/ui/dialog";
// 👇 NEW IMPORTS for the Dropdown/Select component
    ...
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="flex justify-center mb-8 animate-fade-in-up">
            ...
            >
                <SelectTrigger className="w-[250px] bg-card border-white text-card-foreground shadow-lg hover:bg-card/90 transition-colors">
        ...
        {/* Dietary Filter (Remains the same) */}
        <div className="flex flex-wrap justify-center gap-3 mb-12 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          <span className="text-primary-foreground self-center">Filter by:</span>
          {dietaryOptions.map((option) => (
            <Badge
            ...
            >
              ...
              <CardContent className="pt-6">
                ...
                <Button
                  ...
                  size="sm"
                  className="w-full gap-2 bg-secondary text-muted hover:bg-accent/90 hover:text-accent-foreground transition-all duration-300"
                >
                  <Plus className="h-4 w-4" />
                  Add to Cart
                </Button>
      ...
      {/* Item Detail Modal */}
      <Dialog open={!!selectedItem} onOpenChange={() => setSelectedItem(null)}>
        <DialogContent className="max-w-2xl animate-scale-in bg-cover bg-center bg-no-repeat rounded-xl bg-background/90 opacity-2 text-muted"
        // style={{
        //     backgroundImage: `url(${elegantBg})`,
        // }}
