...
import chefRichard from "@/assets/chef_marley.jpg";
...
const ChefsCorner = () => {
  const chefs = [
    {
      ...
      role: "Chef de Parte",
      image: chefRichard,
      bio: "With over 7 years of culinary excellence, Chef Marley  brings a fusion of traditional Ghanaian flavors and contemporary techniques to Elm Café. Born in Kumasi and trained at Le Cordon Bleu Paris, he returned to Ghana with a mission to elevate local cuisine to international standards.",
  ...
  const signatureDishes = [
    {
      ...
      story: "This dish represents Chef Marley's journey from his grandmother's kitchen to Le Cordon Bleu and back home. It's traditional jollof reimagined with premium ingredients and modern techniques, while respecting the soul of the original.",
      ingredients: [
  ...
  const recipes = [
    {
      title: "Chef Marley's Perfect Jollof at Home",
